        ...
        <div class="grid-container grid-container--wpadding">
          <div class="grid-x grid-padding-x">
            ...
            <div class="cell large-12">
                  ...
                  <h2 class="topicholder-section__heading">Browse all jobs by category</h2>

                 <ul class="topicholder-all-list">
                   <% loop $Categories.Sort('Title ASC') %>
                      <li class="topicholder-all-list__item topicholder-all-list__item--avoid-break"><h3 class="topicholder-all-list__item-heading"><a href="$Link">$Title ({$ActiveJobListings})</a></h3>
